...
public class ClienteParticular {
    ...
    private String nroID, tipoID, nombres, apellidos, direccion, correo, telf, prefProd, tipoCliente;
    ...
    public ClienteParticular(String nroID, String tipoID, String nombres, String apellidos, String direccion,
            String correo, String telf, Timestamp fecha, String prefProd, String tipoCliente,
